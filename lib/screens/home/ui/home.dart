            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    if (homeController
                            .response.value.data?.topbaner?.isNotEmpty ==
                        true)
                      CustomSliderWidget(
                          items: homeController.response.value.data?.topbaner ??
                              []),
                    space(h * 0.02),
                    InkWell(
                      onTap: () {
                        var profileController = Get.find<ProfileController>();
                        profileController.onItemTapped(3);
                      },
                      child: Container(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "₹${homeController.response.value.data?.earning}",
                                  style: GoogleFonts.poppins(
                                      color: kWhiteColor,
                                      fontSize: w * 0.045,
                                      fontWeight: FontWeight.w600),
                    ...
                    Obx(() {
                      return homeController
                                  .response.value.data?.webinar?.isNotEmpty ==
                              true
                          ? LimitedBox(
                              maxHeight: h * 0.18,
                              child: Align(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemCount: homeController
                                      .response.value.data?.webinar?.length,
                                  shrinkWrap: true,
                                  ...
                                  itemBuilder:
                                    ...
                                    return Padding(
                                      ...
                                      child: WebinarCard(
                                        webinar: homeController.response.value
                                            .data?.webinar?[index],
                                      ),
                                    );
                                  },
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: AssetImage(
                                    "assets/images/banner_offer.jpg"),
                                fit: BoxFit.fill)),
                      ),
                    ),
                    SizedBox(
